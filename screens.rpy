...
screen main_menu():
    imagemap:
        ...
        hotspot (76, 222, 434, 79) action Start()
        hotspot (77, 408, 433, 52) action ShowMenu("load")
        hotspot (75, 328, 434, 53) action ShowMenu("preferences")
        hotspot (78, 489, 432, 51) action Quit(confirm=False)
